...
def create_paramfile(trans, uploaded_datasets):
    ...
    for uploaded_dataset in uploaded_datasets:
        ...
        if uploaded_dataset.type == 'composite':
            ...
            if link_data_only == 'copy_files' and trans.user and not (uploaded_dataset.path.startswith("http://") or uploaded_dataset.path.startswith("https://") or uploaded_dataset.path.startswith("ftp://")):
